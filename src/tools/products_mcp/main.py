...
def main():
    """Run the MCP server in streamable HTTP mode on port 8080."""
    ...
    logger.info("Starting streamable HTTP server on port 8080")
    
    # Use streamable-http transport for Azure AI Foundry Agent Service compatibility
